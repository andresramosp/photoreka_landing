...
export const darkTheme = {
  ...
  premium: {
    ...
    accentBorder: "rgba(147, 51, 234, 0.32)",
    info: colors.cyan[500],
    infoSoft: "rgba(6, 182, 212, 0.14)",
    infoBorder: "rgba(6, 182, 212, 0.32)",
    success: colors.green[500],
    ...
    dangerSoft: "rgba(236, 72, 153, 0.14)",
    dangerBorder: "rgba(236, 72, 153, 0.32)",
    gradient1: colors.blue[600],
    gradient2: colors.blue[800],
    gradient3: colors.cyan[400],
    heroGrid:
      "linear-gradient(rgba(255, 255, 255, 0.045) 1px, transparent 1px), linear-gradient(90deg, rgba(255, 255, 255, 0.045) 1px, transparent 1px)",
    shadowMd: "0 18px 45px rgba(0, 0, 0, 0.22)",
    shadowXl: "0 28px 90px rgba(0, 0, 0, 0.38)",
...
export const lightTheme = {
  ...
  premium: {
    ...
    infoBorder: "rgba(8, 145, 178, 0.25)",
    success: colors.green[600],
    ...
    dangerSoft: "rgba(219, 39, 119, 0.1)",
    dangerBorder: "rgba(219, 39, 119, 0.25)",
    gradient1: colors.blue[600],
    gradient2: colors.blue[800],
    gradient3: colors.cyan[400],
    heroGrid:
      "linear-gradient(rgba(15, 23, 42, 0.055) 1px, transparent 1px), linear-gradient(90deg, rgba(15, 23, 42, 0.055) 1px, transparent 1px)",
    shadowMd: "0 18px 45px rgba(15, 23, 42, 0.08)",
    shadowXl: "0 28px 90px rgba(15, 23, 42, 0.13)",
    // Hero Strong text styling
...
export function getThemeCSSVariables(isDark = true) {
  ...
  return {
    ...
    "--premium-bg-primary": theme.premium.bgPrimary,
    "--premium-bg-secondary": theme.premium.bgSecondary,
    "--premium-bg-elevated": theme.premium.bgElevated,
    "--premium-surface": theme.premium.surface,
    "--premium-bg-card": theme.premium.bgCard,
    "--premium-bg-nav": theme.premium.bgNav,
    "--premium-bg-hover": theme.premium.bgHover,
    "--premium-glass": theme.premium.glass,
    "--premium-chrome": theme.premium.chrome,
    "--premium-stage-bg": theme.premium.stageBg,
    "--premium-video-bg": theme.premium.videoBg,
    "--premium-border": theme.premium.border,
    "--premium-border-strong": theme.premium.borderStrong,
    ...
    "--premium-primary-soft": theme.premium.primarySoft,
    "--premium-primary-border": theme.premium.primaryBorder,
    "--premium-accent": theme.premium.accent,
    "--premium-accent-soft": theme.premium.accentSoft,
    "--premium-accent-border": theme.premium.accentBorder,
    "--premium-info": theme.premium.info,
    "--premium-info-soft": theme.premium.infoSoft,
    "--premium-info-border": theme.premium.infoBorder,
    "--premium-success": theme.premium.success,
    "--premium-success-soft": theme.premium.successSoft,
    "--premium-success-border": theme.premium.successBorder,
    "--premium-warning": theme.premium.warning,
    "--premium-warning-soft": theme.premium.warningSoft,
    "--premium-warning-border": theme.premium.warningBorder,
    "--premium-danger": theme.premium.danger,
    "--premium-danger-soft": theme.premium.dangerSoft,
    "--premium-danger-border": theme.premium.dangerBorder,
    ...
    "--premium-hero-grid": theme.premium.heroGrid,
    "--premium-shadow-md": theme.premium.shadowMd,
    "--premium-shadow-xl": theme.premium.shadowXl,

          ...
          <div class="section-container">
            <div class="section-header" :class="{ visible: featuresVisible }">
              ...
              <p class="section-subtitle">
                ...
                built right into Lightroom Classic. No need to switch between
                apps.
              </p>
            </div>
...
const faqs = ref([
  ...
  },
  {
    ...
    answer:
      "Analysis speed depends on your catalog size and internet connection. Typically, the plugin processes 100-200 photos per minute. You can continue working in Lightroom while analysis runs in the background.",
  },
  {
    question: "Does it work with my existing keywords and collections?",
    answer:
      "Yes. The plugin respects your existing Lightroom organization. It reads your keywords, collections, and folder structure, using them alongside AI analysis to provide even better search results.",
  },
  {
    question: "What happens if I move or rename photos in Lightroom?",
    answer:
      "The plugin automatically tracks changes in your Lightroom catalog. If you reorganize files, the plugin updates its references automatically on next sync.",
  },
]);
...
const goToPlugin = () => {
  trackUserAction("navigate_to_plugin", "lightroom_plugin_page");
  // Navigate to auth/signup for now - plugin download will be available after login
